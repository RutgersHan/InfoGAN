...
class ConInfoGANTrainer(object):
    ...
    def init_opt(self):
        ...
        with pt.defaults_scope(phase=pt.Phase.train):
            ...
            mi_c_est = tf.constant(0.)
            cross_c_ent = tf.constant(0.)
            ...
            if(len(self.model.con_latent_dist.dists) > 0):
                cont_reg_c = reg_c
                cont_real_reg_c_dist_info = real_reg_c_dist_info
                cont_fake_reg_c_dist_info = fake_reg_c_dist_info
                cont_real_log_q_c_given_x = self.model.con_latent_dist.logli(
                    cont_reg_c, cont_real_reg_c_dist_info)
                cont_fake_log_q_c_given_x = self.model.con_latent_dist.logli(
                    cont_reg_c, cont_fake_reg_c_dist_info
                )
            ...
            self.log_vars.append(("MI_C", mi_c_est))
